...
static uint32_t
chorba_small_nondestructive (uint32_t crc, uint64_t *buf, size_t len)
{
  uint64_t *input = buf;
  uint64_t final[72 / 8] = { 0 };
  unsigned char *final_bytes = (unsigned char *) final;
  uint64_t next1 = crc;
  next1 = next1 << 32;
  crc = 0;
  uint64_t next2 = 0;
  ...
  for (; i + 32 + 40 < len; i += 32)
    {
      ...
      in1 = htobe64 (input[i / 8]) ^ next1;
      in2 = htobe64 (input[i / 8 + 1]) ^ next2;
      ...
      in3 = htobe64 (input[i / 8 + 2]) ^ next3 ^ a1;
      in4 = htobe64 (input[i / 8 + 3]) ^ next4 ^ a2 ^ b1;
  ...
  final[0] ^= be64toh (next1);
  final[1] ^= be64toh (next2);
  final[2] ^= be64toh (next3);
  final[3] ^= be64toh (next4);
  final[4] ^= be64toh (next5);
  ...
  for (int j = 0; j < len - i; j++)
    {
      crc = crctab[0][(crc >> 24) ^ final_bytes[j]] ^ (crc << 8);
    }
...
static uint32_t
chorba_118960_nondestructive (uint32_t crc, uint64_t *buf, size_t len)
{
  if ((118960 * 2) + 512 > len)
  ...
  for (; i < 118784; i += 256)
    {
      ...
      in1 = input[i / 8 + 0] ^ next1;
      in2 = input[i / 8 + 1] ^ next2;
      in3 = input[i / 8 + 2] ^ next3;
      in4 = input[i / 8 + 3] ^ next4;
      in5 = input[i / 8 + 4] ^ next5;
      in6 = input[i / 8 + 5] ^ next6;
      in7 = input[i / 8 + 6] ^ next7;
      in8 = input[i / 8 + 7] ^ next8 ^ in1;
      in9 = input[i / 8 + 8] ^ next9 ^ in2;
      in10 = input[i / 8 + 9] ^ next10 ^ in3;
      in11 = input[i / 8 + 10] ^ next11 ^ in4;
      in12 = input[i / 8 + 11] ^ next12 ^ in1 ^ in5;
      in13 = input[i / 8 + 12] ^ next13 ^ in2 ^ in6;
      in14 = input[i / 8 + 13] ^ next14 ^ in3 ^ in7;
      in15 = input[i / 8 + 14] ^ next15 ^ in4 ^ in8;
      in16 = input[i / 8 + 15] ^ next16 ^ in5 ^ in9;
      in17 = input[i / 8 + 16] ^ next17 ^ in6 ^ in10;
      in18 = input[i / 8 + 17] ^ next18 ^ in7 ^ in11;
      in19 = input[i / 8 + 18] ^ next19 ^ in8 ^ in12;
      in20 = input[i / 8 + 19] ^ next20 ^ in9 ^ in13;
      in21 = input[i / 8 + 20] ^ next21 ^ in10 ^ in14;
      in22 = input[i / 8 + 21] ^ next22 ^ in11 ^ in15;
      in23 = input[i / 8 + 22] ^ in1 ^ in12 ^ in16;
      in24 = input[i / 8 + 23] ^ in2 ^ in13 ^ in17;
      in25 = input[i / 8 + 24] ^ in3 ^ in14 ^ in18;
      in26 = input[i / 8 + 25] ^ in4 ^ in15 ^ in19;
      in27 = input[i / 8 + 26] ^ in5 ^ in16 ^ in20;
      in28 = input[i / 8 + 27] ^ in6 ^ in17 ^ in21;
      in29 = input[i / 8 + 28] ^ in7 ^ in18 ^ in22;
      in30 = input[i / 8 + 29] ^ in8 ^ in19 ^ in23;
      in31 = input[i / 8 + 30] ^ in9 ^ in20 ^ in24;
      in32 = input[i / 8 + 31] ^ in10 ^ in21 ^ in25;
  ...
  for (; i < 119040; i += 256)
    {
      ...
      in21 = input[i / 8 + 20] ^ next21 ^ in10 ^ in14;
      in22 = input[i / 8 + 21] ^ next22 ^ in11 ^ in15;
      in23 = input[i / 8 + 22] ^ in1 ^ in12 ^ in16 ^ bitbuffer[inoffset + 22];
      in24 = input[i / 8 + 23] ^ in2 ^ in13 ^ in17 ^ bitbuffer[inoffset + 23];
      in25 = input[i / 8 + 24] ^ in3 ^ in14 ^ in18 ^ bitbuffer[inoffset + 24];
      in26 = input[i / 8 + 25] ^ in4 ^ in15 ^ in19 ^ bitbuffer[inoffset + 25];
      in27 = input[i / 8 + 26] ^ in5 ^ in16 ^ in20 ^ bitbuffer[inoffset + 26];
      in28 = input[i / 8 + 27] ^ in6 ^ in17 ^ in21 ^ bitbuffer[inoffset + 27];
      in29 = input[i / 8 + 28] ^ in7 ^ in18 ^ in22 ^ bitbuffer[inoffset + 28];
      in30 = input[i / 8 + 29] ^ in8 ^ in19 ^ in23 ^ bitbuffer[inoffset + 29];
      in31 = input[i / 8 + 30] ^ in9 ^ in20 ^ in24 ^ bitbuffer[inoffset + 30];
      in32 = input[i / 8 + 31] ^ in10 ^ in21 ^ in25
        ^ bitbuffer[inoffset + 31];
  ...
  for (; i + 118960 + 512 < len; i += 256)
    {
      ...
      in1 = input[i / 8 + 0] ^ next1 ^ bitbuffer[inoffset + 0];
      in2 = input[i / 8 + 1] ^ next2 ^ bitbuffer[inoffset + 1];
      in3 = input[i / 8 + 2] ^ next3 ^ bitbuffer[inoffset + 2];
      in4 = input[i / 8 + 3] ^ next4 ^ bitbuffer[inoffset + 3];
      in5 = input[i / 8 + 4] ^ next5 ^ bitbuffer[inoffset + 4];
      in6 = input[i / 8 + 5] ^ next6 ^ bitbuffer[inoffset + 5];
      in7 = input[i / 8 + 6] ^ next7 ^ bitbuffer[inoffset + 6];
      in8 = input[i / 8 + 7] ^ next8 ^ in1 ^ bitbuffer[inoffset + 7];
      in9 = input[i / 8 + 8] ^ next9 ^ in2 ^ bitbuffer[inoffset + 8];
      in10 = input[i / 8 + 9] ^ next10 ^ in3 ^ bitbuffer[inoffset + 9];
      in11 = input[i / 8 + 10] ^ next11 ^ in4 ^ bitbuffer[inoffset + 10];
      in12 = input[i / 8 + 11]
        ^ next12 ^ in1 ^ in5 ^ bitbuffer[inoffset + 11];
      in13 = input[i / 8 + 12]
        ^ next13 ^ in2 ^ in6 ^ bitbuffer[inoffset + 12];
      in14 = input[i / 8 + 13]
        ^ next14 ^ in3 ^ in7 ^ bitbuffer[inoffset + 13];
      in15 = input[i / 8 + 14]
        ^ next15 ^ in4 ^ in8 ^ bitbuffer[inoffset + 14];
      in16 = input[i / 8 + 15]
        ^ next16 ^ in5 ^ in9 ^ bitbuffer[inoffset + 15];
      in17 = input[i / 8 + 16]
        ^ next17 ^ in6 ^ in10 ^ bitbuffer[inoffset + 16];
      in18 = input[i / 8 + 17]
        ^ next18 ^ in7 ^ in11 ^ bitbuffer[inoffset + 17];
      in19 = input[i / 8 + 18]
        ^ next19 ^ in8 ^ in12 ^ bitbuffer[inoffset + 18];
      in20 = input[i / 8 + 19]
        ^ next20 ^ in9 ^ in13 ^ bitbuffer[inoffset + 19];
      in21 = input[i / 8 + 20]
        ^ next21 ^ in10 ^ in14 ^ bitbuffer[inoffset + 20];
      in22 = input[i / 8 + 21]
        ^ next22 ^ in11 ^ in15 ^ bitbuffer[inoffset + 21];
      in23 = input[i / 8 + 22] ^ in1 ^ in12 ^ in16 ^ bitbuffer[inoffset + 22];
      in24 = input[i / 8 + 23] ^ in2 ^ in13 ^ in17 ^ bitbuffer[inoffset + 23];
      in25 = input[i / 8 + 24] ^ in3 ^ in14 ^ in18 ^ bitbuffer[inoffset + 24];
      in26 = input[i / 8 + 25] ^ in4 ^ in15 ^ in19 ^ bitbuffer[inoffset + 25];
      ...
      in31 = input[i / 8 + 30] ^ in9 ^ in20 ^ in24 ^ bitbuffer[inoffset + 30];
      in32 = input[i / 8 + 31]
        ^ in10 ^ in21 ^ in25 ^ bitbuffer[inoffset + 31];
  ...
  for (; i + 40 < len; i += 32)
    {
      ...
      in1 = htobe64 (input[i / 8])
        ^ next1 ^ htobe64 (bitbuffer[(i / 8) % bitbuffersizeqwords]);
      in2 = htobe64 (input[i / 8 + 1])
        ^ next2 ^ htobe64 (bitbuffer[(i / 8 + 1) % bitbuffersizeqwords]);
      ...
      in3 = htobe64 (input[i / 8 + 2])
        ^ next3 ^ a1 ^ htobe64 (bitbuffer[(i / 8 + 2) % bitbuffersizeqwords]);
      in4 = htobe64 (input[i / 8 + 3])
        ^ next4 ^ a2 ^ b1
        ^ htobe64 (bitbuffer[(i / 8 + 3) % bitbuffersizeqwords]);
  ...
  for (int j = 0; j < len - i; j++)
    {
      crc = crctab[0][(crc >> 24) ^ final_bytes[j]
                      ^ bitbufferbytes[(j + i) %
                                       bitbuffersizebytes]] ^ (crc << 8);
    }
...
static bool
cksum_chorba_file (FILE *fp, uint_fast32_t *crc_out, uintmax_t *length_out)
{
  uint64_t buf[BUFLEN / sizeof (uint64_t)];
  uint32_t crc = 0;
  uintmax_t len = 0;
  size_t bytes_read;
  ...
  while ((bytes_read = fread (buf, 1, BUFLEN, fp)) > 0)
    {
      ...
      crc = chorba_118960_nondestructive (crc, buf, bytes_read);
